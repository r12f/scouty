...
mod tests {
    ...
    #[test]
    fn test_dispatch_k_returns_consumed() {
        let mut widget = LogTableWidget;
        assert_eq!(
    ...
    #[test]
    fn test_dispatch_arrow_keys_return_consumed() {
        let mut widget = LogTableWidget;
        assert_eq!(
